...
export class MembershipsController {
    ...
    async createApplication(
        ...
        const application = await this.membershipsService.createApplication(
    ...
    async getUserApplications(
        ...
        const applications = await this.membershipsService.getUserApplications(
            userId,
        );
        return applications;
    }
    ...
    async updateMemberRole(
        ...
        return await this.membershipsService.updateMemberRole(
            membershipId,
            role,
        );
    }
